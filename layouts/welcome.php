...
<head>
    ...
    <style>
        body {
            background-image: url('https://img.freepik.com/free-vector/people-walking-sitting-hospital-building-city-clinic-glass-exterior-flat-vector-illustration-medical-help-emergency-architecture-healthcare-concept_74855-10130.jpg?t=st=1734796066~exp=1734799666~hmac=6fd9e6e79f5f732466ad79b2faa4a436a66dd4c6dae872d617a3d1e8dbd69112&w=1060');
            ...
            <?php if ($muncul) : ?>
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        <li class="nav-item"><a class="nav-link" href="http://<?= $_SERVER['HTTP_HOST'] ?>/bk_poliklinik-main/pages/<?= $arah ?>">Dashboard</a></li>
                    </ul>
                </div>
            <?php endif ?>
        </div>
                ...
                <div class="row gx-5 d-flex flex-column text-center">
                    <div class="col-lg-6 mb-5 mx-auto">
                        <div class="card card-custom p-4">
                            ...
                            <a class="text-decoration-none" href="http://<?= $_SERVER['HTTP_HOST'] ?>/bk_poliklinik-main/pages/auth/login-pasien.php">
                    ...
                    <div class="col-lg-6 mb-5 mx-auto">
                        <div class="card card-custom p-4">
                            ...
                            <a class="text-decoration-none" href="http://<?= $_SERVER['HTTP_HOST'] ?>/bk_poliklinik-main/pages/auth/login.php">
